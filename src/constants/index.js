...
const testEnabledAssertIdsData = includeImage => ({
  '0x8d896c37eb6f50f35ddefe472f91f51d30faff549cd251e5f8a4a90a471ab0c8': {
    ...
    imgSrc: includeImage && require('../images/categories/Cryptomining.jpg'),
  },
...
const isAssetIdEnabled = (assetId, includeImage) => {
  let enabledAssetIds = {
    ...
    '0x116dc7388854d37e952a811c1fa2e03369809eef84b7a49ce9ce9536b5f2c66b': {
      ...
      imageSrc: includeImage && require('../images/categories/Co-working.jpg'),
    },
    '0x5125edb815829e8eb1f1944ffb6a4df0365e0340afa018195ba00b5631616657': {
      ...
      imageSrc: includeImage && require('../images/categories/Storage.jpg'),
    },
    '0x77577554da83a746eca3b1ba093942c07535ca946a3561b49f48394c965d641c': {
      ...
      imageSrc: includeImage && require('../images/categories/Cryptomining.jpg'),
    },
    '0x8aa3395398fa2d443fe536246271f41fe5064be02223015e79bec113821ab48b': {
      ...
      imageSrc: includeImage && require('../images/categories/Bitcoinatm.jpg'),
    },
    '0xf6e31cc03282ca18d3914af15a364b846a4327b40807f9930034d4380c333c8f': {
      ...
      imageSrc: includeImage && require('../images/categories/Solar1.jpg'),
    },
