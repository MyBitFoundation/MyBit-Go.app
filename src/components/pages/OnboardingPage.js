            ...
            <CarouselWrapper>
                <Carousel ref={node => this.carousel = node} effect="slide" dots={false} >
                    <Slide>
                        ...
                        <img src={MyBitGoLogo} width="90" className="Onboarding__img-default" alt="MyBit Onboarding Slide 1" />
                        ...
                        <div className="Onboarding__buttons">
                            <Button className="Onboarding__buttons-next" type="primary" onClick={this.next}>
                              More on MyBit Go <img src={RightArrow} className="Onboarding__buttons-next-arrow" alt="Next Button Arrow" />
                            </Button>
                        </div>
                    </Slide>
                    ...
                    <Slide>
                        <Link to="/explore" className="Onboarding__btn-close">+</Link>
                        <img src={MyBitGlobe} width="164" className="Onboarding__img-globe" alt="MyBit Onboarding Slide 2" />
                    ...
                    <Slide>
                        ...
                        <div className="Onboarding__buttons">
                            <Button className="Onboarding__buttons-skip" onClick={() => this.goToSlide(7)}>Skip… I know Blockchain</Button>
                            <Button className="Onboarding__buttons-next" type="primary" onClick={this.next}>
                   ...
                   <Slide>
                    ...
                    <Slide>
                        ...
                        <div className="Onboarding__static-img-wrapper">
                            <img src={SafeGraphic} width="113" className="Onboarding__img-static" alt="MyBit Globe" />
                        </div>
                        <div className="Onboarding__buttons">
                            <Button className="Onboarding__buttons-next" type="primary" onClick={this.next}>
                    ...
                    <Slide>
                        ...
                        <div className="Onboarding__static-img-wrapper">
                            <img src={EthereumGraphic} width="230" className="Onboarding__img-static" alt="MyBit Globe" />
                        </div>
                        <div className="Onboarding__buttons">
                            <Button className="Onboarding__buttons-next" type="primary" onClick={this.next}>
                    ...
                    <Slide>
                        ...
                        <div className="Onboarding__static-img-wrapper">
                            <img src={SmartContract} width="199" className="Onboarding__img-static" alt="MyBit Globe" />
                        </div>
                        <div className="Onboarding__buttons">
                            <Button className="Onboarding__buttons-next" type="primary" onClick={this.next}>
                    ...
                    <Slide>
                        <Link to="/explore" className="Onboarding__btn-close">+</Link>
                        <img src={Key} width="69" className="Onboarding__img-key" alt="MyBit Globe" />
                        <h1 className="Onboarding__main-title">
                        ...
                        <ul className="Onboarding__list--key-security">
                            ...
                            <li className="Onboarding__list-item">For added protection, <a href="https://trezor.io" target="_blank">get a hardware wallet</a>.</li>
                        </ul>
                        <div className="Onboarding__buttons">
                            <Button className="Onboarding__buttons-next" type="primary" onClick={this.next}>
                                Next <img src={RightArrow} className="Onboarding__buttons-next-arrow" alt="Next Button Arrow" />
                    ...
                    <Slide>
                      ...
                      <BancorConsumer>
                        {({ initBancor }) => (
                          <React.Fragment>
                            <img src={SetupGraphic} width="77" className="Onboarding__img-setup" alt="MyBit Globe" />
                            <h1 className="Onboarding__main-title">
                            ...
                            <p className="Onboarding__paragraph--no-images">
                                ...
                                which <br />run on the Network, require MYB to use. <a onClick={() => initBancor()}>Get MYB</a>
                            </p>
                            <p className="Onboarding__paragraph--no-images">
                                Cryptocurrency, such as Ether or DAI, which are the main cryptocurrencies MyBit Go uses to
                                invest in assets; however, many more are supported. <a onClick={() => initBancor({
                                  type: 1,
