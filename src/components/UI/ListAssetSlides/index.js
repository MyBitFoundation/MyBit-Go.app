...
const SlideButtons = ({ nextMessage, disabledMassage, previous, next, forbidNext }) => {
    return (
        <div className="Slider__buttons">
            ...
            <Button type="primary" className="Slider__buttons-continue" onClick={next} disabled={forbidNext}>
...
export const IntroSlide = ({ next }) => (
    <Slide>
        ...
        <div className="Slider__buttons">
            <Button type="secondary" className="Slider__buttons-centered" onClick={next}>PLACEHOLDER CIVIC BUTTON</Button>
        </div>
    </Slide>
)

export const LocationSlide = ({ next, previous, handleInputChange, handleSelectChange, formData }) => {
...
export const FeeSlide = ({ next, previous, handleSelectChange, managementFee }) => {
...
export const CollateralSlide = ({ 
    next, previous, handleCollateralChange, collateralPercentage, 
    collateralMyb, collateralDollar, constraints, formData 
}) => {
        ...
        <div className="Slider__confirm-information">
            <div className="Slider__confirm-entry">
                ...
                <div className="Slider__confirm-entry-note">
                    ...
                    /
                    {formData.userCountry === '' ? '[country missing]' : formData.userCountry}
                </div>
            </div>
            <div className="Slider__confirm-entry">
            ...
            <div className="Slider__confirm-entry">
                ...
                <div className="Slider__confirm-entry-note">
                {formData.assetAddress1 === '' ? '[address missing]' : formData.assetAddress1}
            ...
            <div className="Slider__confirm-entry">
                ...
                <div className="Slider__confirm-entry-note">{formData.managementFee}%</div>
            </div>
            <div className="Slider__confirm-entry">
