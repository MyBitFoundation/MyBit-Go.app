...
export const ExternalLinks = {
  ...
  ETHERSCAN_TX_BY_ADDR_ENDPOINT: address =>
    `https://api-ropsten.etherscan.io/api?module=account&action=txlist&address=${address}&sort=asc&apiKey=${ETHERSCAN_API_KEY}`,
  ETHERSCAN_TX: txHash =>
    `https://api-ropsten.etherscan.io/api?module=transaction&action=gettxreceiptstatus&txhash=${txHash}&apiKey=${ETHERSCAN_API_KEY}`,
